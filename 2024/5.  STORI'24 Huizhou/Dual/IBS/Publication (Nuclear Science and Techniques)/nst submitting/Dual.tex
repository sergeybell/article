...
\begin{document}
	...
	\par For structure where the missing magnet technique is used, for one reason or another it can be also implemented (Fig. \ref{fig:resonant}), but the dispersion at the edge of the arc must be suppressed \cite{b4}. 
	\begin{figure}[!htb]
	...
	\par The behaviour of the $\beta$-functions and $D$ the dispersion across the entire “regular” ring illustrates at Fig. \ref{fig:regular}. The straight sections, which remain constant in all lattices, are essential for analyzing of the resonant characteristics of the entire structure. Their arrangement does not affect the intra-beam scattering and transition energy. To suppress dispersion in the “regular” lattice, ‘missing magnets’ technic implemented on both sides of the arc.
	...
	\begin{table}[!htb]
		...
		\begin{tabular*}{8cm} {@{\extracolsep{\fill} } lccc}
			...
			Stochastic time at $4.5$ GeV/u, s & 2500 & 1500 & 800 \\
			IBS time at $4.5$ GeV/u, s & 2500 & 400 & 250 \\
			Tunes & 9.44x9.44 & 9.44x9.44 & 9.44x9.44 \\
			\bottomrule
		\end{tabular*}
	\end{table}
