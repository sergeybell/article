...
\begin{document}
	...
	\begin{figure}[!htb]
		...
		\caption{(Color online) "Resonant" NICA magneto-optic adapted lattice with increased transition energy and missing magnet.}
		\label{fig:resonant}
	\end{figure}
	...
	\noindent For a beam generated by a multi-harmonic barrier-type RF system, so-called "Barrier Bucket", the particles distribution in the beam can be considered approximately uniform along its entire length. The effective particles number is determined by a simple ratio of the beam length to the total orbit length:
	...
	\par The behaviour of the $\beta$-functions and $D$ the dispersion across the entire “regular” ring illustrates at Fig. \ref{fig:regular} with $\gamma_{\text{tr}} = 7$. The straight sections, which remain constant in all lattices, are essential for analyzing of the resonant characteristics of the entire structure. Their arrangement does not affect the intra-beam scattering and transition energy. To suppress dispersion in the “regular” lattice, ‘missing magnets’ technic implemented on both sides of the arc.
	...
	\begin{figure}[!htb]
		...
		\caption{(Color online) “Regular” FODO NICA magneto-optic lattice with missing magnets.}
		\label{fig:regular}
	\end{figure}
	...
	\begin{figure}[!htb]
		...
		\caption{(Color online) "Combined" NICA magneto-optic lattice with real and complex transition energies in arcs.}
		\label{fig:combined}
	\end{figure}	
	...
	\begin{thebibliography} {99}
		...
		\bibitem{kaon} Golubeva, N. I. and Iliev, A. I. and Senichev, Yu. V., Nonlinear dynamics in the booster of the Moscow Kaon factory, {\it Conf. Proc. C}, PAC-1991-1899, Vol. 910506, P. 1899--1901, 1991.
		\bibitem{jpark}	Y. Mori, [at al.] Synchrotron design issues of the Japanese hadron project, {\it Conf. Proc. C}, INS-1147, Vol. 960610, P. 569--571, 1996.
		\bibitem{neutrino} Autin, B, [at al.], A slow-cycling proton driver for a neutrino factory, 7th European Particle Accelerator Conference (EPAC 2000), CERN-PS-2000-015-AE, 2000.
