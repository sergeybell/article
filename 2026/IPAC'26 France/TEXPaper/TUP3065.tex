...
\par The central output of the mapping workflow is the predicted spin-tune response \(\Delta\nu_s\) versus target chromatic settings, computed from Eqs.~(\ref{eq:control_law})--(\ref{eq:transfer}). For each scan axis, we enforce the cross-plane constraints (Eq.~\ref{eq:constraints}) and compare the ``No fringe'' and ``With fringe'' field models for two probe amplitudes (P0 and P1).

\par We present the results structure-by-structure to facilitate a focused discussion.

\subsection{magnetic\_2p}
\par The ``magnetic\_2p'' lattice represents a purely magnetic ring.
\begin{figure}[!tbh]
	\centering
	\includegraphics[width=\columnwidth]{img/TUP3065_f7}
	\caption{``magnetic\_2p'': Twiss functions.}
	\label{fig:twiss_m2p}
\end{figure}
\begin{figure}[!tbh]
	\centering
...
\par The ``electrostatic'' lattice is a purely electric configuration.
\begin{figure}[!tbh]
	\centering
	\includegraphics[width=\columnwidth]{img/TUP3065_f8}
	\caption{``electrostatic'': Twiss functions.}
	\label{fig:twiss_es}
\end{figure}
\begin{figure}[!tbh]
	\centering
	...
	\end{minipage}
	\caption{``electrostatic'': \(\Delta\nu_s\) vs \(\xi_x\) (left) at \(\xi_y=0,\,\eta_1=0\) and vs \(\eta_1\) (right) at \(\xi_x=0,\,\xi_y=0\).}
	\label{fig:es_xz}
\end{figure}

\subsection{Nuclotron\_8}
\par The ``Nuclotron\_8'' lattice represents a quasi-frozen spin configuration with combined electric and magnetic fields.
\begin{figure}[!tbh]
	\centering
	\includegraphics[width=\columnwidth]{img/TUP3065_f9}
	\caption{``Nuclotron\_8'': Twiss functions.}
	\label{fig:twiss_n8}
\end{figure}
\begin{figure}[!tbh]
	\centering
	...
	\end{minipage}
	\caption{``Nuclotron\_8'': \(\Delta\nu_s\) vs \(\xi_x\) (left) at \(\xi_y=0,\,\eta_1=0\) and vs \(\eta_1\) (right) at \(\xi_x=0,\,\xi_y=0\).}
	\label{fig:n8_xz}
\end{figure}

\section{Results and discussion}
\par The linear model and the constrained scans are evaluated for three representative lattice variants: a purely magnetic lattice (``magnetic\_2p''), a purely electrostatic lattice (``electrostatic''), and a quasi-frozen spin lattice (``Nuclotron\_8''). The results are presented in the previous section and compared below in terms of response matrices and sensitivity trends.
