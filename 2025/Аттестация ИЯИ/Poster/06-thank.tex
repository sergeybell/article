...
\begin{frame}
	...
	\footnotetext[1]{Kolokolchikov, S., Senichev, Y., Aksentev, A. et al. Longitudinal Dynamic in NICA Barrier Bucket RF System at Transition Energy Including Impedances in BLonD. Phys. Part. Nuclei Lett. 21, 419–424 (2024). https://doi.org/10.1134/S1547477124700389}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{frame}
	...
	\footnotetext[1]{(to be published) Kolokolchikov, S.D., et al. Quasi-frozen spin for both deuteron and proton beam at periodic EDM storage ring lattice, Nucl.Sci. and Tech.}
\end{frame}
%------------------------------------------------