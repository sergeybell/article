...
\title{Исследование динамики поляризованного пучка в
	...
	ядер}
\subtitle{Итоговая аттестация 1.3.2 «Приборы и методы экспериментальной физики»}
\author{Аспирант ИЯИ РАН Колокольчиков C. Д.}

\institute[]{
{\normalsize Научный руководитель: профессор, доктор ф.-м. наук Сеничев Ю.В.}\newline \newline
