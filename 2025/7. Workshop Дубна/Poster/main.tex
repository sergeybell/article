...
%---------------------------------------------------------
\title{Особенности дуальной магнитооптической структуры синхротрона для тяжелых и легких поляризованных частиц}
% Click the middle footer can switch between the first and last numbered frame
%\subtitle{XHU}
\author{Колокольчиков С.Д., Аксентьев А.Е., Мельников А.А., Сеничев Ю.В.}
